...
mod executor_results_tests {
    ...
    fn test_executor_includes_results_in_context() {
        ...
        let question_block = Block::new("question", Some("analyze-data"), "Analyze this data: <meta:reference target=\"data-generator.results\" />");
    ...
    fn test_executor_applies_display_modifiers() {
        ...
        let inline_ref = "<meta:reference target=\"inline-example.results\" />";
        let block_ref = "<meta:reference target=\"block-example.results\" />";
        let none_ref = "<meta:reference target=\"none-example.results\" />";
    ...
    fn test_executor_applies_format_modifiers() {
        ...
        let markdown_ref = "<meta:reference target=\"markdown-example.results\" />";
        let code_ref = "<meta:reference target=\"code-example.results\" />";
        let plain_ref = "<meta:reference target=\"plain-example.results\" />";
    ...
    fn test_executor_applies_content_modifiers() {
        ...
        let preview_ref = "<meta:reference target=\"preview-example.results\" />";
        let full_ref = "<meta:reference target=\"full-example.results\" />";
    ...
    fn test_executor_results_processing_chain() {
        ...
        let complex_ref = "<meta:reference target=\"complex-example.results\" />";
    ...
    fn test_results_integration_in_workflow() {
        ...
        data = <meta:reference target="initial-data" />
        ...
        Initial data: <meta:reference target="processor.results" />
    ...
    fn test_executor_handles_error_results() {
        ...
        <meta:reference target="error-code.error_results" />
        </meta:question>
        "#;
